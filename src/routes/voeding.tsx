...
import rawFoodAsset from "@/assets/voeding-hero.png.asset.json"; const rawFood = rawFoodAsset.url;
import dogCatAsset from "@/assets/hond-kat-gras.png.asset.json"; const dogCat = dogCatAsset.url;
